...
CREATE TABLE `tbl_parent`  
        ...
        `Address`text NOT NULL,
         ...
         ` mobile_number` varchar(200) NOT NULL,
          `Alternative_mobile_number` varchar(200) NOT NULL,
          ` job_status` varchar(200) NOT NULL, 
          `username` varchar(200) UNIQUE NOT NULL,
           `password` VARCHAR(500) NOT NULL, 
           ` image`VARCHAR(200) NOT NULL) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
...
(2,'Jonathan Gonzalez','1810 Kuhl Avenue Gainesville, GA 30501','jonathan12@gmail.com','$2y$10$s2MmR/Ml6ohRRrrFY0SRQ.vWohGvthVsKe59zgLOIvm3Qd0PzavD2','B.Sc, B.Ed','2019-05-01','5cdd2ed638edc.jpg',2,1),
(3,'Peter Parker','620 Jody Road, Philadelphia, PA 19108','peter_parker@gmail.com','$2y$10$jmgJN1xvteg6XqBnHvT7UerviGNJOSnF8KFzBHnCky0FJWa74Nvmu','M.Sc, B. Ed','2017-12-31','5ce53488d50ec.jpg',3,2),
(4,'John Smith','780 University Drive, Chicago, IL 60606','john.smith@gmail.com','$2y$10$Vb9t4CvkJwm41KXgPehuLOFcM7o5Qdm1RFxSBxzh9cvBcc21AUAiW','B.Sc','2019-05-01','5cdd2f35be8fa.jpg',4,3),
(5,'Donna Hubber','3354 Round Table Drive, Cincinnati, OH 45240','donna.huber@gmail.com','$2y$10$SVxX4/7lf3pDs1vrpuJexOG7Ue1e1jqIntGmXip3JzxkB753uxBiO','M.Sc','2019-05-01','5cdd2f767568c.jpg',5,4);
