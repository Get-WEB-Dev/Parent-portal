...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      <a class="navbar-brand pb-0" href="index.php"><img src="assets/img/logo.png" alt="Logo" style="width:80px;height:70px;padding-bottom:0;"></a>
      <h1 class="logo mr-auto d-block" style="font-size:20px;"><a class="d-block text-primary" href="index.php">Hermata Secondary School <h2 style="font-size:15px;">Parent Portal</h2></h1></a>
        ...
        <ul>
          ...
          <li class="drop-down"><a href="">Login <i class='bx bxs-down-arrow'></i></a> 
            <ul>
              ...
              <li><a href="login.php">Parent</a></li>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex justify-content-center align-items-center" style="background-image: url('assets/img/a4.jpg');background-size: 100% 100%;">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1 >Welcome To<br class="text-primary">Hermata Secondary School <br> Parent Portal</h1>
