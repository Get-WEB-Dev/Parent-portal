...
<div class="modal w-70" id="formModal">
  <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Parent phone<span class="text-danger">*</span></label>
              <div class="col-md-8">
                <input type="number" name="parent_phone" id="parent_phone" class="form-control"/>
                <span id="error_parent_phone" class="text-danger"></span>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <span id="error_student_image" class="text-danger"></span>
              </div>
            </div>
          </div>
        </div>
...
$(document).ready(function(){
    ...
    $('#error_parent_phone').text('');
    $('#error_student_image').text('');
	}
	...
	$('#student_form').on('submit', function(event){
		...
		$.ajax({
          ...
          if(data.error_parent_phone != '')
					{
						$('#error_parent_phone').text(data.error_parent_phone);
					}
					else
					{
						$('#error_parent_phone').text('');
  ...
  $(document).on('click', '.edit_student', function(){
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        $('#parent_phone').val(data.student_parent_id);
        $('#error_student_image').html('<img src="teacher_image/'+data.student_image+'" class="img-thumbnail" width="50" />');
  			$('#hidden_student_image').val(data.student_image);
