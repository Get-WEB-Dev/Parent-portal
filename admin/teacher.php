        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8">
                <select name="teacher_subject_id" id="teacher_subject_id" class="form-control">
                  <option value="">Select Subject</option>
                  <?php
                  echo load_subject_list($connect);
                  ?>
                </select>
                <span id="error_teacher_subject_id" class="text-danger"></span>
              </div>
            </div>
          </div>
          <div class="form-group">
...
$(document).ready(function(){
    ...
    $.ajax({
      ...
      success:function(data){
        ...
        { 
          ...
          if(data.error_teacher_subject_id != '')
          {
            $('#error_teacher_subject_id').text(data.error_teacher_subject_id);
          }
          else
          {
            $('#error_teacher_subject_id').text('');
  ...
  $(document).on('click', '.edit_teacher', function(){
  	...
  	$.ajax({
        ...
        $('#teacher_subject_id').val(data.teacher_subject_id);
